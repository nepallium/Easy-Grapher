...
![2 graphs](demo/1.png)
![graph intersections](demo/2.png)
![precise point viewing](demo/3.png)

## Key Features

- **Multi-Function Plotting:** Input and display up to 2 functions simultaneously.
- **Derivative Analysis:** Automatically calculate and display the derivative of any plotted function using _Math
  Eclipse_'s **Symja** library.
